...
```bash
curl -A "Prerender (+https://github.com/prerender/prerender)" https://marketerpro.com/
```
...
3. Enter your URL: `https://marketerpro.com/`
...
Accessible at: `https://marketerpro.com/sitemap.xml`
...
### 1. Test Homepage
```bash
curl -A "Prerender" https://marketerpro.com/
```

### 2. Test Teacher Recruitment Page
```bash
curl -A "Googlebot" https://marketerpro.com/join-us
```
